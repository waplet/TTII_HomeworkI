...
<html lang="en">
	...
	<div class="container">
		...
		<div class="form-group">
		    <input name="amount" type="text" class="form-control" placeholder="This amount of..." autofocus>
		</div>
		...
		<div class="form-group" >
		    ...
		    <label for="sourceLVL">
			<input type="radio" name="source" id="sourceLVL" value="LVL">
			LVL
		    </label>
		    <label for="sourceEUR">
			<input type="radio" name="source" id="sourceEUR" value="EUR">
			EUR
		    </label>    
		</div>
